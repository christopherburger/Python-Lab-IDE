...
The current version has self-hosting enabled. You can default to loading pyodide from the cdn by adjusting *script src* and commenting out *indexURL: "./pyodide/"* in the *loadPyodideEnvironment * function. The set of static files needed is provided in the repository in the *pyodide* folder.
