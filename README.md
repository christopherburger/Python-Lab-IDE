...
Persistent Auto-Save: Keystrokes are continuously saved to the browser's localStorage. If a computer crashes or a browser tab is accidentally refreshed during an exam, the student's entire workspace and tab structure is instantly recovered.
